...
$formurl = "http://$host$uri/index.html" ;
$errorurl = "http://$host$uri/feederror.html" ;
$thankyouurl = "http://$host$uri/feedok.html" ;
...
$use_utf8 = 1;
$my_recaptcha_private_key = '6Lfi6AkAAAAAAGfSnfkw1OmEgIW_2_5HEBFZXyYM';
...
$http_referrer = getenv( "REMOTE_ADDR" );
...
$query="INSERT INTO feeds VALUES('0','$fullname','$email','$comments')";
mysql_query($query);
mysql_close();
